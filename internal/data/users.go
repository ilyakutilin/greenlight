...
// Inserts a new record in the database for the user. Note that the id, created_at and
...
// Retrieves the User details from the database based on the user's email address.
...
// Updates the details for a specific user. Notice that we check against the version
// field to help prevent any race conditions during the request cycle. And we also check
// for a violation of the "users_email_key" constraint when performing the update.
...
// Retrieves the details of a specific user based on the token they provided.
