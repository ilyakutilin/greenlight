...
func (app *application) serve() error {
	...
	go func() {
		...
		// It's a buffered channel with size 1.
		...
		// Log a message to say that the the server is shutting down. Notice that we
		...
		// hit). If it returns an error, we relay this error to the shutdownError
		// channel.
	...
	// Start the server, registering any error.
